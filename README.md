...
<h1 align="center">Crypto Photos marketplace</h1>
...
- The name "Crypto Photos Market" is also copyright protected and should be changed to the name of your market.
...
Crypto Photos Market comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
